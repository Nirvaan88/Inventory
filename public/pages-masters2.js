    ...
    <tr data-id="${d.ID}" class="lm-row">
      ...
      <td style="text-align:center">
        <div style="display:flex;gap:6px;justify-content:center">
          ...
          <button class="btn btn-warning btn-sm" onclick="showLoginMasterForgotPasswordModal('${(d.LoginID||'').replace(/'/g,"\\'")}', '${(d.SecurityQtn||'').replace(/'/g,"\\'")}', ${d.ID})"
...
window.showLoginMasterForgotPasswordModal = (loginId = '', secQtn = '', rowId) => {
