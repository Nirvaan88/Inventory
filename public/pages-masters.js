...
window._pageBinders['divisions'] = async () => {
  ...
  $('#div-select-all').onchange = (e) => {
    $$('.div-row-chk').forEach(c => { c.checked = e.target.checked; updateDivBulkBar(); });
  };
...
window._pageBinders['departments'] = async () => {
  ...
  $('#dept-select-all').onchange = (e) => {
    $$('.dept-row-chk').forEach(c => { c.checked = e.target.checked; updateDeptBulkBar(); });
  };
...
window._pageBinders['categories'] = async () => {
  ...
  $('#cat-select-all').onchange = (e) => {
    $$('.cat-row-chk').forEach(c => { c.checked = e.target.checked; updateCatBulkBar(); });
  };
...
window._pageBinders['states'] = async () => {
  ...
  $('#state-select-all').onchange = (e) => {
    $$('.state-row-chk').forEach(c => { c.checked = e.target.checked; updateStateBulkBar(); });
  };
...
window._pageBinders['cities'] = async () => {
  ...
  $('#city-select-all').onchange = (e) => {
    $$('.city-row-chk').forEach(c => { c.checked = e.target.checked; updateCityBulkBar(); });
  };
...
window._pageBinders['couriers'] = async () => {
  ...
  $('#courier-select-all').onchange = e => {
    $$('.cr-row-chk').forEach(c => { c.checked = e.target.checked; }); updateCourierBulkBar();
  };
...
window._pageBinders['kisna-region'] = async () => {
  ...
  $('#krs-select-all').onchange = (e) => {
    $$('.krs-row-chk').forEach(c => { c.checked = e.target.checked; updateKRSBulkBar(); });
  };
...
window._pageBinders['category-codes'] = async () => {
  ...
  $('#catcode-select-all').onchange = (e) => {
    $$('.catcode-row-chk').forEach(c => { c.checked = e.target.checked; updateCatCodeBulkBar(); });
  };
...
window._pageBinders['item-vendor-map'] = async () => {
  ...
  $('#ivm-select-all').onchange = (e) => {
    $$('.ivm-row-chk').forEach(c => { c.checked = e.target.checked; updateIVMBulkBar(); });
  };
...
window._pageBinders['items'] = async () => {
  ...
  $('#item-select-all').onchange = (e) => {
    $$('.item-row-chk').forEach(c => { c.checked = e.target.checked; updateItemBulkBar(); });
  };
